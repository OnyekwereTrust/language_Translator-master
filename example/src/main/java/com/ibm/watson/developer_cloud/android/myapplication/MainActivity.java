...
//        msgView.smoothScrollToPosition(msgList.getCount() - 1);
        ...
        try {
          jObject = new JSONObject(String.valueOf(mssg));
        } catch (JSONException e) {
          e.printStackTrace();
        }
        JSONObject jsonOutput = null;
        try {
          jsonOutput = jObject.getJSONObject("output");
        } catch (JSONException e) {
          e.printStackTrace();
        }
        JSONArray jArray1 = null;
        try {
          jArray1 = jsonOutput.getJSONArray("text");
        } catch (JSONException e) {
          e.printStackTrace();
        }
...
//              msgView.smoothScrollToPosition(msgList.getCount() - 1);
        ...
        try {
          jArray2 = jObject.getJSONArray("intents");
        } catch (JSONException e) {
          e.printStackTrace();
        }
